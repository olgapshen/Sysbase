...
Программа должна быть скомпилирована с опцией `-g` переданной в `gcc`. Если вы собираете с `CMake`,
...
> По идее вверху окна с кодом должны быть кнопи конроля процесса отладки, их нет, возможно из за версии `Vim`: `8.0`; пишут, что нужна версия `8.1`
